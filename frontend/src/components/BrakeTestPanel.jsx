      ...
      <div className="bg-white rounded-2xl shadow-[0_4px_24px_-4px_rgba(0,0,0,0.06)] border border-gray-100 overflow-hidden">
        ...
        <div className="p-6">
          ...
          >
            ...
            <div className="absolute -top-8 -right-8 w-40 h-40 rounded-full opacity-12 blur-xl bg-red-500" />
            <div className="absolute -bottom-8 -left-8 w-32 h-32 rounded-full opacity-12 blur-xl bg-red-500" />
